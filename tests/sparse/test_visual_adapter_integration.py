...
def test_adapter_executes_guided_tokens_and_publishes_effective_options(monkeypatch, tmp_path):
    ...
    def predict_action(self, **kwargs):
        with torch.no_grad():
            return self.model.sample_action(**inputs).squeeze(0).numpy()
