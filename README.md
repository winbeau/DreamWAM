> **Evaluation experiment — `experiment/dido-sparse-profile`**: the [H100 50-pair report](docs/implementation/dido-sparse-profile/H100-FIFTYPAIRS-REPORT.md) is complete: Dense50/50 versus candidate42/50, a16pp SR loss exceeding the allowed5pp. Warm prediction is2.031× faster; whole-episode time rises39.00%. All100 new attempts completed without errors/retries; the conserved cumulative ledger is132/132. No further evaluation is queued. GPU3/4 retain the requested finite120-minute holds; release commands are in the report. [Earlier study](docs/implementation/dido-sparse-profile/REPORT.md), [data sources](docs/implementation/dido-sparse-profile/SOURCES.md), [workflow](docs/implementation/dido-sparse-profile/WORKFLOW.md), and historical [paper evaluation](docs/action-eval/README.md) remain separate. Upstream attribution is preserved; execution is server-only with unchanged dependencies.
