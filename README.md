> **Evaluation experiment — `experiment/dido-sparse-profile`**: the latest [H100 ten-pair result](docs/implementation/dido-sparse-profile/H100-TENPAIRS-REPORT.md) is Dense9/10 versus candidate8/10, warm prediction1.994×, whole-episode latency36.83→43.95s. The user now authorizes a separate [50-pair comparison](docs/implementation/dido-sparse-profile/H100-FIFTYPAIRS-20260921.md),100 new attempts, cumulative cap132. The frozen candidate and protocol are unchanged. [Earlier study](docs/implementation/dido-sparse-profile/REPORT.md), [data sources](docs/implementation/dido-sparse-profile/SOURCES.md), [workflow](docs/implementation/dido-sparse-profile/WORKFLOW.md), and historical [paper evaluation](docs/action-eval/README.md) remain separate. Upstream attribution is preserved; execution is server-only with unchanged dependencies.
