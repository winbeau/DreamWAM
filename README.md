> **Evaluation experiment — `experiment/dido-sparse-profile`**: [active goal and evidence](docs/implementation/dido-sparse-profile/PROGRESS.md), [native Q/K/V profiler](docs/implementation/dido-sparse-profile/PROFILE.md), [data sources](docs/implementation/dido-sparse-profile/SOURCES.md), [deployment workflow](docs/implementation/dido-sparse-profile/WORKFLOW.md). H100 CPU verification passes 33 tests; CUDA/checkpoint profiling and new speed/SR results remain pending GPU admission. This effort is capped at 50 closed-loop episode attempts total across arms, with a 5-percentage-point SR-drop tolerance. Historical [paper-evaluation results](docs/action-eval/README.md) remain separate. Upstream instructions and attribution below are preserved; execution remains server-only with unchanged dependencies.
