...
DIDO_HOST=H200-target-server
DIDO_SERVER_BASE=/data/chenjiayu/wenbiao_zhao/dreamwam-sr/DreamWAM
DIDO_SERVER_TREE=/data/chenjiayu/wenbiao_zhao/dreamwam-sr/.trees/dido-sparse-profile
...
DIDO_BRANCH=$3
DIDO_EXPECTED_SHA=$4
DIDO_ASSETS=/data/chenjiayu/wenbiao_zhao/dreamwam-sr/DreamWAM
...
if [[ ! -e "$DIDO_TREE" ]]; then
    mkdir -p -- /data/chenjiayu/wenbiao_zhao/dreamwam-sr/.trees
