...
Latest coverage at **2026-09-20 01:00 UTC**: [Dense 368/500 (361 successes, seven task failures), eager temporal 184/500 successes and temporal graph 144/500 successes](guided-graph-full-spatial-20260920.md), all with live recovery controllers. A separate guided graph full run has started on GPU 4 after its completed pilot; it has 0/500 terminal outcomes after an initial native renderer abort and is in bounded recovery. Old guided outcomes remain separate. No full SR is available yet.
