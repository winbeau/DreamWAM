...
Formal Spatial evaluation started at 05:44 UTC, with independent **500-identity
Dense and Sparse** plans; the new rendering lineage is not pooled with old runs.
