...
GPU5 for policy and empty GPU6 for EGL rendering, leaving GPU7 unused;
run the two five-pair lanes sequentially and recheck admission. The user first
corrected to groups2/3 and6/7, then explicitly approved5/6 after2/3 were occupied.
The requested temporary torch holds on5/6/7 are released for this real run.
